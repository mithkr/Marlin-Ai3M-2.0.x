...
#define STRING_CONFIG_H_AUTHOR "(mithkr, TMC2208 PDN_UART [X/Y/E] config)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.77, 80.23, 400.14, 394.00 }
/**
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, -15, 0 } // Anycubic i3 Mega X-Carriage [MK4] https://www.thingiverse.com/thing:3537449
...
#define X_MIN_POS -11.3
#define Y_MIN_POS -2.8
#define Z_MIN_POS 0
